...
class ProjectList(ListCreateAPIView):
    ...
    def get(self, request, format=None):
        ...
        client_data = ClientSerializer(Client.objects.all(), many=True).data
        project_type_data = ProjectTypeSerializer(ProjectType.objects.all(), many=True).data
        project_manager_data = ProjectManagerSerializer(ProjectManager.objects.all(), many=True).data
        account_manager_data = AccountManagerSerializer(AccountManager.objects.all(), many=True).data
        relationship_manager_data = RelationshipManagerSerializer(RelationshipManager.objects.all(), many=True).data
        consultant_data = ConsultantSerializer(Consultant.objects.all(), many=True).data
