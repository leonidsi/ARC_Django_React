...
const columns = [
                  'name', 'projectManagerName', 'accountManagerName', 'relationshipManagerName',  
                  'consultantName', 'clientName', 'projectTypeName', 'survey_id', 'revenue'
                ]
const allColumns = [
                      'clientName', 'name', 'survey_id', 'project_type_id', 'accountManagerName', 
                      'relationshipManagerName', 'projectManagerName', 'consultant_id', 'data_manager', 
                      'revenue', 'toolkit_id', 'sso_id', 'contracted_launch_date', 'contract_expiration_date', 
                      ...
                      'contracted_rpt_translations', 'number_historical_uploads', 'num_exec_decks', 'num_exec_interviews', 
                      'onsite_pres_id', 'server_id', 'new_business_id', 'sheet_id', 'project_kickoff_date', 'survey_launch_date', 
                      'exec_first_draft_date', 'exec_presentation_date', 'project_close_date', 'project_team_training_date', 
                      'question_final_date', 'online_survey_final_date', 'List.pilot_launch_date', 'final_data_date', 
                      'ship_paper_date', 'manager_account_release_date', 'actual_invitees', 'actual_email_invitees', 
                      'actual_kiosk_invitees', 'actual_paper_invitees', 'actual_paper_surveys', 'actual_dc_translations', 
                      'actual_report_users', 'actual_rpt_translations', 'actual_exec_interviews', 'actual_exec_decks', 
