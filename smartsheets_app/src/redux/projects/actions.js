const projectActions = {
    ...
    FETCH_PROJECT_HISTORIES_REQUEST: 'FETCH_PROJECT_HISTORIES_REQUEST',
    FETCH_PROJECT_HISTORIES_SUCCESS: 'FETCH_PROJECT_HISTORIES_SUCCESS',
    FETCH_PROJECT_HISTORIES_ERROR: 'FETCH_PROJECT_HISTORIES_ERROR',
    fetchProjectHistories: payload => ({
        type: projectActions.FETCH_PROJECT_HISTORIES_REQUEST,
        payload
    }),
