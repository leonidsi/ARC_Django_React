...
class ProjectStatusList(ListCreateAPIView):
    ...
    def get(self, request, format=None):
        ...
        """
        project_statuses = ProjectStatus.objects.all().order_by('id')
...
class ProjectStatusDetailView(RetrieveUpdateDestroyAPIView):
    ...
    * Allow only authenticated project_statuses to access this url
    """
    permission_classes = (IsAuthenticated and IsTokenValid,)
    queryset = ProjectStatus.objects.all().order_by('id')
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            response = {"message": "Project Status with id: {} does not exist".format(kwargs["pk"])}
    ...
    def delete(self, request, *args, **kwargs):
        try:
            ...
            response = {"message": "Deleted Project Status Successfully!"}
