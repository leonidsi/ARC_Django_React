...
const allColumns = [
                      'clientName', 'name', 'survey_id', 'projectTypeName', 'accountManagerName', 
              ...
              <Collapse style={{margin: '10px'}} >
                <Panel header="Advanced Search" key="1">
                  ...
                  <InputSearch
                    ...
                    value={searchTypes.accountManagerName}
                    onChange={e => this.searchAdvanced(columns[2], e.target.value)}
                    style={{...inputSearchStyle}}
                  />
                  <InputSearch
                    placeholder="Relationship Manager Name"
                    value={searchTypes.relationshipManagerName}
                    onChange={e => this.searchAdvanced(columns[2], e.target.value)}
                    style={{...inputSearchStyle}}
                  />
                  <InputSearch
                    placeholder="Consultant Name"
                    value={searchTypes.consultantName}
                  ...
                  <InputSearch
                    ...
                    value={searchTypes.project_type}
                    onChange={e => this.searchAdvanced(columns[5], e.target.value)}
                    style={{...inputSearchStyle}}
                  />
                  <InputSearch
                  ...
                  <InputSearch
                    placeholder="Revenue"
                    value={searchTypes.revenue}
                    onChange={e => this.searchAdvanced(columns[7], e.target.value)}
                    style={{...inputSearchStyle}}
                  />
                </Panel>
              </Collapse>
